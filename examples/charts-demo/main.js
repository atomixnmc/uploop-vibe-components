// Charts Showcase — 19 chart types, left-nav, live demos
...
const catalog = [
    ...
    charts: [
      {
        ...
        mount() { mountInto(LineChart.create({
  ...
  showDots: true,
      ...
      },
      {
        ...
        mount() { mountInto(AreaChart.create({
          data: [
  ...
  stacked: true, opacity: 0.3, showDots: true,
      ...
      },
      {
        ...
        mount() { mountInto(StockChart.create({
          data: [
    ...
    charts: [
      {
        ...
        mount() { mountInto(BarChart.create({
  ...
  labels: ['Mar','Apr','May','Jun','Jul','Aug'],
      ...
      },
      {
        ...
        mount() { mountInto(HorizontalBarChart.create({
          data: [{ label: 'Product A', value: 95 }, { label: 'Product B', value: 82 }, { label: 'Product C', value: 78 }, { label: 'Product D', value: 65 }],
          title: 'Top Products',
        }), 'demo-hbar') },
  ...
  title: 'Top Products',
      ...
      },
      {
        ...
        mount() { mountInto(BidirectionalBarChart.create({
          left:  [{ label: '18-24', value: 12 }, { label: '25-34', value: 18 }, { label: '35-44', value: 14 }],
          right: [{ label: '18-24', value: 10 }, { label: '25-34', value: 16 }, { label: '35-44', value: 15 }],
  ...
  leftLabel: 'Male', rightLabel: 'Female',
      ...
      },
      {
        ...
        mount() { mountInto(RadarChart.create({
          axes: [
            { label: 'Speed', max: 100 },
            { label: 'Power', max: 100 },
  ...
  filled: true, showDots: true,
      ...
      },
      {
        ...
        mount() { mountInto(BulletChart.create({
    ...
    charts: [
      {
        ...
        mount() { mountInto(PieChart.create({
          data: [
  ...
  donut: true, showLegend: 'side',
      ...
      },
      {
        ...
        mount() { mountInto(Treemap.create({
          data: {
            name: 'Revenue',
            children: [
  ...
  data: { name:'Revenue', children: [
    ...
    { name:'APAC', value:200 },
      ...
      },
      {
        ...
        mount() { mountInto(WordCloud.create({
          words: [
    ...
    charts: [
      {
        ...
        mount() { mountInto(FunnelChart.create({
          data: [
  ...
  data: [
    ...
    { stage:'Paid', value:480 },
      ...
      },
      {
        ...
        mount() { mountInto(SankeyChart.create({
          nodes: [
            { id: 'A', label: 'Source A' },
            { id: 'B', label: 'Source B' },
            { id: 'C', label: 'Target X' },
  ...
  showValues: true,
      ...
      },
      {
        ...
        mount() { mountInto(WaterfallChart.create({
          data: [
    ...
    charts: [
      {
        ...
        mount() { mountInto(ScatterPlot.create({
          data: [
  ...
  xLabel: 'CAR %', yLabel: 'NPL %',
      ...
      },
      {
        ...
        mount() { mountInto(Heatmap.create({
          data: [
            [0.12, 0.05, 0.08, 0.03],
            [0.03, 0.01, 0.02, 0.06],
            [0.09, 0.15, 0.11, 0.04],
  ...
  colorScale: ['#15803d','#ca8a04','#b91c1c'],
      ...
      },
      {
        ...
        mount() { mountInto(NetworkGraph.create({
          nodes: [
    ...
    charts: [
      {
        ...
        mount() { mountInto(GaugeChart.create({
          value: 72,
          max: 100,
          label: 'Performance',
          sub: 'Good',
  ...
  leftLabel: 'Low', rightLabel: 'High',
      ...
      },
      {
        ...
        mount() { mountInto(ComboChart.create({
          sectors: [
          ...
          line: [{ value: 45 }, { value: 52 }, { value: 48 }, { value: 65 }],
          lineColor: '#fa5252',
